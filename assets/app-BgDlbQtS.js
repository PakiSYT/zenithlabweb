...
<div class="nav-menu-btn" onclick="document.getElementById('mobile-nav').classList.add('open')" style="cursor:pointer">
...
`,G=`<div class="page" id="page-print3d">
...
`,K=`<div class="page" id="page-archmodels">
<div class="services-page">
...
`,q=`<div class="page" id="page-engraving">
<div class="services-page">
...
`,J=`<div class="page" id="page-prototypes">
<div class="services-page">
...
`,U=`<div class="page" id="page-portfolio">
...
</div>`,V=`<div class="page" id="page-contact">
...
`,_=`<!-- FILE: src/pages/blog-archmodel.html -->
...
`,Q=`<!-- FILE: src/pages/blog-led-light.html -->
...
`,ee=`<!-- FILE: src/pages/blog-3dproto.html -->
...
`,ae=`<!-- FILE: src/pages/blog-glass.html -->
...
`,E={home:"Zenith Lab — makiety, laser CNC, grawer i druk 3D",print3d:"Druk 3D i prototypy — Zenith Lab",archmodels:"Makiety architektoniczne deweloperskie — Zenith Lab",led:"Kasetony LED podświetlane — Zenith Lab",engraving:"Grawer i cięcie laserem CNC — Zenith Lab",prototypes:"Prototypy produktów — Zenith Lab",gadgets:"Gadżety reklamowe z grawerem — Zenith Lab",portfolio:"Realizacje — makiety, laser, LED, druk 3D — Zenith Lab",contact:"Kontakt — wycena makiety, lasera, druku 3D — Zenith Lab",blog:"Blog — materiały, laser CNC, makiety, LED — Zenith Lab","blog-material":"Drewno, sklejka czy plexi? Dobór materiału pod laser CNC — Zenith Lab","blog-archmodel":"Makieta architektoniczna: skala, detal, materiał — Zenith Lab","blog-led-light":"Jednolite podświetlenie LED w kaszetonie — Zenith Lab","blog-nfc":"Brelok NFC z grawerem — zastosowania i planowanie — Zenith Lab","blog-3dproto":"Druk 3D przed formą wtryskową — co sprawdzić — Zenith Lab","blog-glass":"Grawerowanie szkła laserem CO2 — efekty i ograniczenia — Zenith Lab","not-found":"404 — Zenith Lab"},ie="✓ Wysłano — dziękujemy!",L="zenith-main",k={home:T,print3d:G,archmodels:K,led:R,engraving:q,prototypes:J,gadgets:H,portfolio:U,contact:V,blog:X,"blog-material":Y,"blog-archmodel":_,"blog-led-light":Q,"blog-nfc":$,"blog-3dproto":ee,"blog-glass":ae,"not-found":ne};function C(){const e=document.documentElement.dataset.zenithPage;return e==="not-found"?"not-found":e&&e in k?e:"home"}function S(){const e=window.location.hash.replace(/^#/,"");return e&&e in k?e:null}function oe(e){if(!e||e.startsWith("mailto:")||e.startsWith("tel:")||e.startsWith("http")||!e.endsWith(".html"))return null;const n=(e.replace(/\\/g,"/").split("/").pop()??e).replace(/\.html$/,"");return n==="index"?"home":n==="404"?"not-found":n in k?n:null}function te(){if(document.getElementById(L))return;const e=S()??C();document.body.insertAdjacentHTML("afterbegin",I+`<div id="${L}"></div>`+B),j(e)}function re(e){const a=e==="print3d"||e==="archmodels"||e==="led"||e==="engraving"||e==="prototypes"||e==="gadgets";document.querySelectorAll("#nav .nav-links a[data-n]").forEach(n=>{n.classList.remove("active");const i=n.getAttribute("data-n");i===e&&n.classList.add("active"),i==="services"&&a&&n.classList.add("active")})}function se(){var e;(e=document.getElementById("mobile-nav"))==null||e.classList.remove("open")}function Z(){const e=document.querySelectorAll(".page .reveal:not(.visible)");if(!e.length)return;const a=new IntersectionObserver(n=>{n.forEach(i=>{i.isIntersecting&&i.target instanceof HTMLElement&&(i.target.classList.add("visible"),a.unobserve(i.target))})},{threshold:.12,rootMargin:"0px 0px -40px 0px"});e.forEach(n=>a.observe(n))}function F(e){if(e!=="home")return;[{id:"c1",target:127,duration:1800},{id:"c2",target:6,duration:1400},{id:"c3",target:15,duration:1600}].forEach(({id:n,target:i,duration:o})=>{const t=document.getElementById(n);if(!t)return;const r=t,p=performance.now();function y(c){const l=Math.min((c-p)/o,1),z=1-Math.pow(1-l,3);r.textContent=String(Math.round(z*i)),l<1&&requestAnimationFrame(y)}requestAnimationFrame(y)})}function le(e){e.disabled=!0,e.innerHTML=ie,e.style.background="#1a4a00",e.style.cursor="default"}window.addEventListener("load",()=>{setTimeout(()=>{var e;(e=document.getElementById("loader"))==null||e.classList.add("hide")},1800)});window.addEventListener("scroll",()=>{const e=document.getElementById("nav");e&&e.classList.toggle("scrolled",window.scrollY>40)},{passive:!0});function ce(){document.addEventListener("click",e=>{const a=e.target,n=a==null?void 0:a.closest("#page-portfolio .filter-btn");if(!n)return;document.querySelectorAll("#page-portfolio .filter-btn").forEach(o=>o.classList.remove("active")),n.classList.add("active");const i=n.dataset.filter;i&&document.querySelectorAll("#pf-grid .portfolio-item").forEach(o=>{const t=i==="all"||o.dataset.filter===i;o.style.display=t?"":"none"})})}const de=[{cat:"Figurki 3D · model",title:"Figurki 3D",desc:"Druk 3D z ręcznym wykończeniem",photos:["img/portfolio/orzel.jpg","img/portfolio/hero-background.jpg","img/portfolio/figurka.jpg"]},{cat:"Gadżety · merch",title:"Magnesy personalizowane",desc:"Seria personalizowana dla klienta",photos:["img/portfolio/magnes.jpg"]},{cat:"Grawer · drewno",title:"Stolik z grawerem laserowym",desc:"Grawer dekoracyjny, drewno naturalne",photos:["img/portfolio/stolik grawer.jpg"]},{cat:"Kaseton LED",title:"Logo podświetlane — recepcja",desc:"Równomierne światło, kolor z brand booka",photos:["img/portfolio/polexpert.jpg","img/portfolio/image0 (14).jpg"]},{cat:"Makieta · deweloper",title:"Zagospodarowanie terenu, osiedle mieszkaniowe",desc:"Prezentacja inwestycji w biurze sprzedaży",photos:["img/portfolio/makietaaglowne.jpeg","img/portfolio/makietaa.jpeg","img/portfolio/makietaa2.jpeg","img/portfolio/makietaa3.jpeg","img/portfolio/makietaa4.jpeg","img/portfolio/makietaa5.jpeg","img/portfolio/makieta architektoniczna 2.jpeg","img/portfolio/makieta architektoniczna.jpeg","img/portfolio/makieta architektoniczna 3.jpeg"]},{cat:"Prototyp · gadżet",title:"Lampka nocna, obudowa głosnika",desc:"Prototyp funkcjonalny z elementami docelowymi, do testów użytkowych",photos:["img/portfolio/lampka nocna.jpeg","img/portfolio/obudowa glosnik.jpeg","img/portfolio/obudowa glosnik2.jpeg"]},{cat:"Deski grawerowane · kuchnia",title:"Deski do krojenia z personalizowanym grawerem",desc:"Drewno, laser CNC",photos:["img/portfolio/deska wosp.jpeg","img/portfolio/grawer.jpg"]}],s={project:null,photo:0};function pe(e){document.body.style.overflow="hidden",requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.classList.add("is-open")})})}function ye(e){const a=de[e];if(!(a!=null&&a.photos.length))return;const n=document.getElementById("zlb"),i=document.getElementById("zlb-track"),o=document.getElementById("zlb-thumbs"),t=document.getElementById("zlb-cat"),r=document.getElementById("zlb-title"),p=document.getElementById("zlb-desc"),y=document.getElementById("zlb-counter");if(!n||!i||!o||!t||!r||!p||!y)return;s.project=a,s.photo=0,t.textContent=a.cat,r.textContent=a.title,p.textContent=a.desc,i.innerHTML="",o.innerHTML="",a.photos.forEach((P,u)=>{const w=document.createElement("img");w.src=P,w.alt=a.title,u===0?(w.loading="eager",w.fetchPriority="high"):w.loading="lazy",u===0&&w.classList.add("zactive"),i.appendChild(w);const v=document.createElement("div");v.className="zlb-thumb"+(u===0?" zactive":""),v.tabIndex=0;const h=document.createElement("img");h.src=P,h.alt="",h.loading=u===0?"eager":"lazy",v.appendChild(h);const A=u;v.addEventListener("click",()=>g(A)),o.appendChild(v)}),O(y);const c=a.photos.length<=1,l=document.getElementById("zlb-prev"),z=document.getElementById("zlb-next");l&&(l.style.display=c?"none":""),z&&(z.style.display=c?"none":"");const m=i.querySelector("img"),f=()=>pe(n);m&&"decode"in m?m.decode().then(f).catch(f):f()}function x(){var e;(e=document.getElementById("zlb"))==null||e.classList.remove("is-open"),document.body.style.overflow="",s.project=null}function O(e){const a=s.project;a&&(e.textContent=`${s.photo+1} / ${a.photos.length}`)}function g(e){var y,c,l,z,m;const a=s.project;if(!a)return;const n=document.getElementById("zlb-track"),i=document.getElementById("zlb-thumbs"),o=document.getElementById("zlb-counter");if(!n||!i||!o)return;const t=n.querySelectorAll("img"),r=i.querySelectorAll(".zlb-thumb"),p=a.photos.length;!p||!t.length||((y=t[s.photo])==null||y.classList.remove("zactive"),(c=r[s.photo])==null||c.classList.remove("zactive"),s.photo=(e%p+p)%p,(l=t[s.photo])==null||l.classList.add("zactive"),(z=r[s.photo])==null||z.classList.add("zactive"),(m=r[s.photo])==null||m.scrollIntoView({behavior:"auto",block:"nearest",inline:"center"}),O(o))}let M=!1;function ze(){M||(M=!0,document.addEventListener("click",e=>{const a=e.target,n=a==null?void 0:a.closest("#page-portfolio .pf-card-trigger");if(n){const o=n.closest(".portfolio-item");if(!o)return;const t=parseInt(o.getAttribute("data-project")??"",10);if(Number.isNaN(t))return;e.preventDefault(),e.stopPropagation(),ye(t);return}const i=document.getElementById("zlb");if(i!=null&&i.classList.contains("is-open")){if(a!=null&&a.closest("#zlb-bg")){x();return}if(a!=null&&a.closest("#zlb-close")){x();return}if(a!=null&&a.closest("#zlb-prev")){g(s.photo-1);return}if(a!=null&&a.closest("#zlb-next")){g(s.photo+1);return}}}),document.addEventListener("keydown",e=>{const a=document.getElementById("zlb");a!=null&&a.classList.contains("is-open")&&(e.key==="Escape"&&x(),e.key==="ArrowLeft"&&g(s.photo-1),e.key==="ArrowRight"&&g(s.photo+1))}))}function me(){const e=document.getElementById("zlb-stage");if(!e)return;let a=null;e.addEventListener("touchstart",n=>{var i;a=((i=n.touches[0])==null?void 0:i.clientX)??null},{passive:!0}),e.addEventListener("touchend",n=>{var o;if(a===null)return;const i=(((o=n.changedTouches[0])==null?void 0:o.clientX)??a)-a;Math.abs(i)>48&&g(s.photo+(i<0?1:-1)),a=null},{passive:!0})}function we(){const e=document.getElementById("cursor-ring");if(!e)return;const a=e;let n=0,i=0,o=0,t=0,r=!1;document.addEventListener("mousemove",c=>{n=c.clientX,i=c.clientY,r||(a.style.opacity="1",r=!0)},{passive:!0}),document.addEventListener("mouseleave",()=>{a.style.opacity="0"}),document.addEventListener("mouseenter",()=>{r&&(a.style.opacity="1")});function p(){o+=(n-o)*.15,t+=(i-t)*.15,a.style.left=o+"px",a.style.top=t+"px",requestAnimationFrame(p)}p();const y="a,button,.service-card,.work-card,.pricing-card,.portfolio-item,.blog-card,.testi-card,.nav-item-dropdown";document.addEventListener("mouseover",c=>{var z;(z=c.target)!=null&&z.closest(y)&&(a.style.width="36px",a.style.height="36px",a.style.borderColor="rgba(200,255,87,0.7)")}),document.addEventListener("mouseout",c=>{var m;const l=c.relatedTarget;(m=l==null?void 0:l.closest)!=null&&m.call(l,y)||(a.style.width="20px",a.style.height="20px",a.style.borderColor="var(--accent)")})}function j(e){const a=document.getElementById(L);if(!a)return;const n=k[e]?e:"not-found";document.documentElement.dataset.zenithPage=n,window.location.hash=n==="home"?"":`#${n}`,a.innerHTML=k[n]??k["not-found"],document.title=E[n]??E["not-found"],re(n),Z(),n==="portfolio"&&me(),setTimeout(()=>F(n),600),window.scrollTo({top:0,behavior:"smooth"})}window.navigatePage=j;const d={photos:[],idx:0};function ge(){var a,n,i,o;let e=document.getElementById("svc-lb");return e||(e=document.createElement("div"),e.id="svc-lb",e.className="svc-lb",e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.innerHTML='<div class="svc-lb-bg" id="svc-lb-bg"></div><div class="svc-lb-shell"><div class="svc-lb-stage" id="svc-lb-stage"><div class="svc-lb-track" id="svc-lb-track"></div><button class="svc-lb-arrow svc-lb-prev" id="svc-lb-prev" aria-label="Poprzednie">&#8592;</button><button class="svc-lb-arrow svc-lb-next" id="svc-lb-next" aria-label="Następne">&#8594;</button><button class="svc-lb-close" id="svc-lb-close" aria-label="Zamknij">&#x2715;</button><div class="svc-lb-counter" id="svc-lb-counter"></div></div></div>',document.body.appendChild(e),(a=e.querySelector("#svc-lb-bg"))==null||a.addEventListener("click",D),(n=e.querySelector("#svc-lb-close"))==null||n.addEventListener("click",D),(i=e.querySelector("#svc-lb-prev"))==null||i.addEventListener("click",()=>b(d.idx-1)),(o=e.querySelector("#svc-lb-next"))==null||o.addEventListener("click",()=>b(d.idx+1))),e}function ke(e,a=0){d.photos=e,d.idx=a;const n=ge(),i=document.getElementById("svc-lb-track");i&&(i.innerHTML="",e.forEach((o,t)=>{const r=document.createElement("img");r.src=o,r.alt="",r.loading=t===0?"eager":"lazy",t===0&&r.classList.add("svc-active"),i.appendChild(r)})),W(),ue(),document.body.style.overflow="hidden",requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("is-open")))}function D(){var e;(e=document.getElementById("svc-lb"))==null||e.classList.remove("is-open"),document.body.style.overflow=""}function b(e){var o,t;const a=d.photos.length,n=(e%a+a)%a,i=document.getElementById("svc-lb-track");if(i){const r=i.querySelectorAll("img");(o=r[d.idx])==null||o.classList.remove("svc-active"),(t=r[n])==null||t.classList.add("svc-active")}d.idx=n,W()}function W(){const e=document.getElementById("svc-lb-counter");e&&(e.textContent=`${d.idx+1} / ${d.photos.length}`)}function ue(){const e=d.photos.length<=1,a=document.getElementById("svc-lb-prev"),n=document.getElementById("svc-lb-next");a&&(a.style.display=e?"none":""),n&&(n.style.display=e?"none":"")}let N=!1;function ve(){if(N)return;N=!0,document.addEventListener("click",a=>{const n=a.target,i=n==null?void 0:n.closest(".service-visual[data-imgs]");if(!i)return;a.preventDefault();let o=[];try{o=JSON.parse(i.dataset.imgs??"[]")}catch{o=[]}o.length&&ke(o)}),document.addEventListener("keydown",a=>{const n=document.getElementById("svc-lb");n!=null&&n.classList.contains("is-open")&&(a.key==="Escape"&&D(),a.key==="ArrowLeft"&&b(d.idx-1),a.key==="ArrowRight"&&b(d.idx+1))});let e=null;document.addEventListener("touchstart",a=>{var i;const n=document.getElementById("svc-lb");n!=null&&n.classList.contains("is-open")&&(e=((i=a.touches[0])==null?void 0:i.clientX)??null)},{passive:!0}),document.addEventListener("touchend",a=>{var o;const n=document.getElementById("svc-lb");if(!(n!=null&&n.classList.contains("is-open"))||e===null)return;const i=(((o=a.changedTouches[0])==null?void 0:o.clientX)??e)-e;Math.abs(i)>48&&b(d.idx+(i<0?1:-1)),e=null},{passive:!0})}te();ce();ze();ve();we();Z();setTimeout(()=>F(C()),600);document.addEventListener("click",e=>{var i;const a=(i=e.target)==null?void 0:i.closest("a[href]");if(!a)return;const n=oe(a.getAttribute("href"));n&&(e.preventDefault(),j(n))});window.addEventListener("hashchange",()=>{const e=S();e&&e!==C()&&j(e)});window.closeMobileNav=se;window.handleFormSubmit=le;
